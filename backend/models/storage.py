...
class StorageEngine:
    ...
    def _ensure_files(self):
        defaults = {
            ...
            self.questions_file: {},
            self.syllabi_file: {},
            self.quiz_history_file: [],
            self.papers_file: [],
            self.generated_file: [],
            self.quizzes_file: {},
            self.study_plans_file: {}
        }
    ...
    def get_syllabus(self, subject_id):
        return self.get_syllabi().get(subject_id)
    ...
    def save_syllabus(self, subject_id, syllabus):
        all_syllabi = self.get_syllabi()

        all_syllabi[subject_id] = syllabus
    ...
    def get_quiz_history(self, subject_id):
        return [
            ...
            if h.get("subject_id") == subject_id
        ]
